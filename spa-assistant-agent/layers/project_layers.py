...
class Layers(Construct):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        chromadb_jp = aws_lambda.LayerVersion(
            self, "chromadb_jp", code=aws_lambda.Code.from_asset("./layers/chromadb_jp.zip"),
            compatible_runtimes = [
                aws_lambda.Runtime.PYTHON_3_8,
                aws_lambda.Runtime.PYTHON_3_9,
                aws_lambda.Runtime.PYTHON_3_10,
                aws_lambda.Runtime.PYTHON_3_11], 
            description = 'chromadb_jp')

        
        self.chromadb_jp = chromadb_jp
